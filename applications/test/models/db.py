...
def init_auth(globals, db, config):
    ...
    auth.settings.login_form = RPXAccount(request, api_key='44c8e5d8381402fc066bb186128a50301abb35d6',domain='https://xchg.rpxnow.com/',
    url = "http://localhost:8000/%s/default/user/login" % request.test)'''
